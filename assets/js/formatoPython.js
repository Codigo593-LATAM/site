...
Prism.languages.c = {
  ...
  keyword: /\b(?:_(?=\s*:)|and|as|assert|async|await|break|case|class|continue|def|if|else|except|exec|finally|for|from|global|if|import|in|is|scanf|printf|raise|return|try|while|with|yield|char|int|float)\b/,
